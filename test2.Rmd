...
# display only seasons played on season summary on franchise page by counting seasons played and displaying by tail
...
talking_busch_list = readHTMLTable(talking_busch, header=T, which=12, stringsAsFactors=F)
